...
my $xml_file = 't/samples/antlers.xsp';
...
$xt->ok( 'not(/page/div/p[@class="error"])', 'No internal errors' );

$xt->is( '/page/div[@id="test1"]/p/text()', 'Yep, trait accessor available.', 'Trait accessor worked.' );
